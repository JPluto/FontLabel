...
/*!
 @method     
 @abstract   Loads a AES encrypted TTF font from the main bundle.  (Some lisences do not allow ttf files to be included without encription)
 @param filename The name of the font file to load (with or without extension).
 @param encryptionKey The key with what the font file was encrypted.
 @return YES if the font was loaded, NO if an error occurred
 @discussion If the font has already been loaded, this method does nothing and returns YES.
 This method first attempts to load the font by appending .aes to the filename.
 If that file does not exist, it tries the filename exactly as given.
 */
- (BOOL)loadEncryptedFont:(NSString *)filename withEncryptionKey:(NSString*)encryptionKey;
/*!
 @method
 @abstract	Loads a AES encrypted font from the given file URL.  (Some lisences do not allow ttf files to be included without encription)
 @param url A file URL that points to a font file
 @param encryptionKey The key with what the font file was encrypted.
 @return YES if the font was loaded, NO if an error occurred
 @discussion If the font has already been loaded, this method does nothing and returns YES.
...
/*!
 @method
 @abstract	save an TTF file (from url) with AES encryption. (Some lisences do not allow ttf files to be included without encription)
 @param url A file URL that points to a font file
 @param encryptionKey The key with what the font file was encrypted.
 @return YES if the font was loaded, NO if an error occurred
 @discussion If the font has already been loaded, this method does nothing and returns YES.
...
/*!
 @method
 @abstract	save an TTF file (from filename) with AES encryption. (Some lisences do not allow ttf files to be included without encription)
 @param url A file URL that points to a font file
 @param encryptionKey The key with what the font file was encrypted.
 @return YES if the font was loaded, NO if an error occurred
 @discussion If the font has already been loaded, this method does nothing and returns YES.
